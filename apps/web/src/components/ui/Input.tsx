      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={cn(
            ...
            "transition-colors focus:border-brand-500 dark:focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:focus:ring-brand-400/20",
