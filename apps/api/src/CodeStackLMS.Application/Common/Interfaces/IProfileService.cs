...
public interface IProfileService
{
    ...
    Task<ProfileUserDto> UpdateProfileAsync(string userId, string name, string town, string phoneNumber, string gitHubUsername, string? avatarBlobPath = null, string? email = null, CancellationToken cancellationToken = default);
