...
namespace CodeStackLMS.Infrastructure.Migrations
{
    ...
    [Migration("20260805161208_AddGraduationCertificate")]
    partial class AddGraduationCertificate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("CourseId", "AnnouncedAt")
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.LessonArtifact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.ProgressReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StudentId", "WeekOf", "ReportType")
                        .HasDatabaseName("IX_ProgressReports_StudentId_WeekOf_ReportType");

                    b.ToTable("ProgressReports", (string)null);
                });

            modelBuilder.Entity("CodeStackLMS.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("CertificateBlobPath")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.Property<string>("ProbationReason")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.UserAdminNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserAdminNotes", (string)null);
                });

            modelBuilder.Entity("CodeStackLMS.Domain.Entities.UserCourseEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.LessonArtifact", b =>
                {
                    b.HasOne("CodeStackLMS.Domain.Entities.Lesson", "Lesson")
                        .WithMany("Artifacts")
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.PasswordResetToken", b =>
                {
                    b.HasOne("CodeStackLMS.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.UserAdminNote", b =>
                {
                    b.HasOne("CodeStackLMS.Domain.Entities.User", "AuthorUser")
                        .WithMany("AdminNotesAuthored")
                        .HasForeignKey("AuthorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CodeStackLMS.Domain.Entities.User", "TargetUser")
            ...
            modelBuilder.Entity("CodeStackLMS.Domain.Entities.User", b =>
                {
                    b.Navigation("AdminNotesAuthored");
